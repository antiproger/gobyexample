...
func main() {
	...
	// В отличие от массивов длина среза зависит от содержащихся
	...
	// Срезы имеют несколько дополнительных особенностей
	// по сравнению с массивами. Одна из них - функция `append`,
